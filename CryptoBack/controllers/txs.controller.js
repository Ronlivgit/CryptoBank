...
const { completeSignedTx , decryptAccountInfo , readTxByTxHash} = require("../middleware/walletFunctions");
...
const sendTx = async(req,res) => { 
    ...
    try {
        ...
        await txData.save()
        return res.status(200).send({message: "Transfered successfully." , recipt : 
